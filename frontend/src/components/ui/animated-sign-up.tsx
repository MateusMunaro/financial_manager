...
const AnimatedSignUp: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="register-header" style={{ marginBottom: "2rem", textAlign: "center" }}>
          <h1
            style={{
              fontSize: "2.5rem",
              fontWeight: "700",
              marginBottom: "0.5rem",
              color: getThemeColor(colors.text.primary),
              background: getThemeColor(colors.gradient.primary),
        ...
        <form className="register-form" onSubmit={handleSubmit} style={{ marginBottom: "2rem" }}>
          {error && (
            <div
              style={{
                padding: "1rem",
          ...
          <div style={{ marginBottom: "1.5rem", position: "relative" }}>
            ...
            <label
              ...
              style={{
                position: "absolute",
                left: "1rem",
                top: isNameFocused || name ? "0.5rem" : "50%",
                transform: isNameFocused || name ? "translateY(0)" : "translateY(-50%)",
          ...
          <div style={{ marginBottom: "1.5rem", position: "relative" }}>
            ...
            <label
              ...
              style={{
                position: "absolute",
                left: "1rem",
                top: isConfirmPasswordFocused || confirmPassword ? "0.5rem" : "50%",
                transform:
                  isConfirmPasswordFocused || confirmPassword ? "translateY(0)" : "translateY(-50%)",
                fontSize: isConfirmPasswordFocused || confirmPassword ? "0.75rem" : "1rem",
                color: getThemeColor(colors.text.secondary),
                pointerEvents: "none",
                transition: "all 0.3s ease",
              }}
        ...
        >
          ...
          ></div>
          <span style={{ padding: "0 1rem" }}>ou cadastre-se com</span>
          <div
            style={{
              flex: 1,
              height: "1px",
